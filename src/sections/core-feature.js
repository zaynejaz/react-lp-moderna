...
const data = {
  subTitle: 'For Ecommerce Business',
  title: 'Actionable insights to drive more sales with reporting and analytics tools',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      ...
      text:
        'Easily keep track of the sales that Moderna is driving you with spot-on revenue attribution and reporting based on sales generated across all campaigns and automations. ',
    },
    {
      id: 2,
      imgSrc: Secure,
